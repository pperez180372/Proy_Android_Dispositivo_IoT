...
import static com.example.ppere.Estresador_Orion.R.id.seekBar1;
import android.widget.SeekBar;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* crear los listeners */
         ...
         initializeVariables();
         seekValue.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            int progress = 0;
                    @Override
                    public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {

                        TextView r=(TextView) (findViewById(R.id.textView_Value_Entity));
                        r.setText(""+progresValue);
                        String nameresource = ((TextView) (findViewById(R.id.textView_rr_name))).getText().toString();
                        String value_Temp = ((TextView) (findViewById(R.id.textView_Value_Entity))).getText().toString();
